...
export async function carregarDashboard(
  ...
  let consulta = supabase
    .from("contratos")
    .select(
      "data_venda, data_assinatura, data_ativacao, data_cancelamento, motivo_cancelamento, status, desistencia_em, assinatura_dispensada, valor_mensalidade, pop_id, plano_id, origem_cadastro"
    )
  ...
  let consultaPendencias = supabase
    .from("contratos")
    .select(
      "id, data_venda, data_assinatura, data_ativacao, data_cancelamento, motivo_cancelamento, status, desistencia_em, assinatura_dispensada, valor_mensalidade"
    )
