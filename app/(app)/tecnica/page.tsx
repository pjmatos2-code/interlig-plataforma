  ...
  return (
    <>
      <CabecalhoPagina
        ...
        descricao="Só OS ENCERRADA pontua. Ativação/mudança de endereço: ATM R$ 30 · BN e VTX R$ 15 · suporte R$ 10 (técnicos habilitados). Retorno por queda de conexão (LOS/sem acesso) em 72h anula a OS de origem."
      />
