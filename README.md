...
Painel por Vendedora + Metas (3.2/3.7), Esteira de Ativação (3.5), CRM Comercial (3.9), Qualidade da Venda (3.8), Ranking gamificado (3.3), Comissionamento (seção 6), Mapa de calor (3.6), Modo TV (/tv) e worker
